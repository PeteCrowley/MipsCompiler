  ...
  fun printtree (outstream, s0) =
    let
      ...
      and exp (T.BINOP (p, a, b), d) =
        ...
        | exp (T.TEMP 2, d) =
            (indent d; say "TEMP "; say ("V0"))
        | exp (T.TEMP 4, d) =
            (indent d; say "TEMP "; say ("A0"))
        | exp (T.TEMP 5, d) =
            (indent d; say "TEMP "; say ("A1"))
        | exp (T.TEMP 6, d) =
            (indent d; say "TEMP "; say ("A2"))
        | exp (T.TEMP 7, d) =
            (indent d; say "TEMP "; say ("A3"))
        | exp (T.TEMP 30, d) =
            (indent d; say "TEMP "; say ("FP"))
        | exp (T.TEMP 29, d) =
            (indent d; say "TEMP "; say ("SP"))
        | exp (T.TEMP 31, d) =
            (indent d; say "TEMP "; say ("RA"))
        | exp (T.TEMP t, d) =
        ...
        | exp (T.CONST i, d) =
            (indent d; say "CONST "; say (Int.toString i))
        | exp (T.CALL (e, el), d) =
            ( indent d
            ; sayln "CALL("
            ; exp (e, d + 1)
